        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
          {FeaturesData.map((data, index) => (
            <div
              ...
              className="text-center group space-y-3 sm:space-y-6 p-4 sm:py-10 bg-white dark:bg-gray-800 shadow-xl dark:shadow-none hover:bg-gradient-to-r from-primary to-secondary hover:shadow-[0_0_40px_#007cfff0] text-black dark:text-white hover:text-black dark:hover:text-black rounded-lg duration-300"
            >
              ...
              <a
                href={data.link}
                className="inline-block text-lg font-semibold py-3 text-primary group-hover:text-black dark:text-primary dark:group-hover:text-black duration-300"
              >
                Learn More
              </a>
            </div>
